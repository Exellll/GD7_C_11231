    ...
    <div class="table-container">
        <div class="content-index">
            <div class="title">
                ...
                <p><i class="fa-solid fa-location-dot" style="color: #ffffff; margin-right: 10px"></i> Jamsil Sports Complex - Seoul Olympic Stadium</p>
                <p><i class="fa-regular fa-hourglass" style="color: #ffffff; margin-right: 10px"></i> 2022.09.17 - 2022.09.18</p>
            </div>
            <div class="mt-4">
                <h4>Seating Plan</h4>
                <hr>
